  ...
  var PAGE_TEMPLATE = {
    ...
    sections: [
      ...
      },
      {
        ...
        style: null,
        blocks: [],
        defaultContent: [".title", ".byline"]
      },
      {
        id: "rc4",
        name: "article-body",
        selector: [".cmp-contentfragment--san-diego-surfspots", ".contentfragment"],
        style: null,
        blocks: [],
        defaultContent: [".cmp-contentfragment--san-diego-surfspots"]
      },
      {
        id: "rc5",
        name: "author-bio",
        selector: [".cmp-experiencefragment--justin-barr", ".experiencefragment"],
        style: null,
        blocks: ["author-bio"],
        defaultContent: []
      },
      {
        id: "rc6",
        name: "sidebar",
        selector: [".cmp-layoutcontainer--sidebar", "aside.cmp-layoutcontainer--sidebar"],
        style: "sidebar",
        blocks: ["cards-related"],
        defaultContent: [".cmp-title--right"]
      }
    ]
  };
  var transformers = [
