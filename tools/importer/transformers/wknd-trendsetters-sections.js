 ...
 * Uses payload.template.sections (selectors DOM-verified during page analysis).
 *
 * Breaks inserted in beforeTransform (while every section element still exists,
 * before parsers replace them); Section Metadata inserted in afterTransform,
 * anchored to a marker <hr> or the surviving section element. Sections iterated
