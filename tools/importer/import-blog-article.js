...
const PAGE_TEMPLATE = {
  name: 'blog-article',
  description: 'Article detail page: article header with cover image and byline, followed by long-form body content with headings, lists, and inline images.',
  urls: [
  ...
  sections: [
    { id: 's1', name: 'Article header', selector: '#main-content > section.section:nth-of-type(1)', style: null, blocks: ['columns-media'], defaultContent: [] },
    { id: 's2', name: 'Article body', selector: '#main-content > section.section:nth-of-type(2)', style: 'article-content', blocks: [], defaultContent: ['#main-content > section.section:nth-of-type(2) > div.container > div.blog-content'] },
  ],
};

// TRANSFORMER REGISTRY - cleanup runs first, sections after (both dual-hook aware)
const transformers = [
  cleanupTransformer,
...
export default {
  transform: (payload) => {
    ...
    // 6. Generate sanitized path (prefixed with /ema-test folder)
