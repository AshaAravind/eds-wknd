...
const parsers = { "columns-media": columnsMediaParser, "cards-article": cardsArticleParser };
...
const transformers = [ cleanupTransformer, ...(PAGE_TEMPLATE.sections && PAGE_TEMPLATE.sections.length > 1 ? [sectionsTransformer] : []) ];
